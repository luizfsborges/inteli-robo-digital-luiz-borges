...
func mensagem_recebida():
	...
	mover_garra(x_atual, z_atual, movimento_x, movimento_z, $Sprite_garra)
...
func mover_garra(posicao_atual_x, posicao_atual_z, \
				posicao_x, posicao_z, sprite_movimentacao):

	var delta_deslocamento_x = abs(posicao_x - posicao_atual_x)
	var delta_deslocamento_z = abs(posicao_z - posicao_atual_z)
	var delta_deslocamento = max(delta_deslocamento_x, delta_deslocamento_z)
